...
2. Ensure any project name placeholders (for example, `Wolfgang.Etl.Json`) have been replaced with your actual project name (the automated setup scripts should normally do this for you)
...
1. Run the GitHub Pages setup script:
   ...
   - **Replace placeholders** in DocFX files (Wolfgang.Etl.Json, https://Chris-Wolfgang.github.io/ETL-Json/, etc.)
