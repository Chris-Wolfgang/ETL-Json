...
namespace Wolfgang.Etl.Json.Tests.SourceLink;

public class SourceLinkPdbTests
{
    private const string RepoSlug = "Chris-Wolfgang/ETL-Json";


    private const string RuntimePdbFileName = "Wolfgang.Etl.Json.pdb";
