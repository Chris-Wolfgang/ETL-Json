...
/// <summary>
/// Construction-time configuration for <see cref="JsonMultiStreamExtractor{TRecord}"/> (ADR-0009).
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed record JsonMultiStreamExtractorOptions : ExtractorOptions
{
    /// <summary>
